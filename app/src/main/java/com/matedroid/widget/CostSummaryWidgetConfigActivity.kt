...
@AndroidEntryPoint
class CostSummaryWidgetConfigActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            MateDroidTheme {
                ...
                var selectedRange by remember { mutableStateOf(CostSummaryWidgetRange.DEFAULT) }
                var selectedCarId by remember { mutableStateOf<Int?>(null) }

                LaunchedEffect(Unit) {
                    val glanceId = GlanceAppWidgetManager(this@CostSummaryWidgetConfigActivity)
                        .getGlanceIdBy(appWidgetId)
                    val prefs = getAppWidgetState(
                        this@CostSummaryWidgetConfigActivity,
                        PreferencesGlanceStateDefinition,
                        glanceId,
                    )
                    selectedRange = CostSummaryWidgetRange.fromDays(
                        prefs[CostSummaryWidget.RANGE_DAYS_KEY]
                            ?: CostSummaryWidgetRange.DEFAULT.days
                    )
                    selectedCarId = prefs[CostSummaryWidget.CAR_ID_KEY]
    ...
    private fun PickerScreen(
        cars: List<CarData>,
        selectedRange: CostSummaryWidgetRange,
        selectedCarId: Int?,
        onRangeSelected: (CostSummaryWidgetRange) -> Unit,
            ...
            LazyColumn(
                ...
                item {
                    Column(
                        ...
                        Text(
                            text = stringResource(R.string.cost_widget_range_title),
                        ...
                        Row(
                            ...
                            CostSummaryWidgetRange.values().forEach { range ->
                                FilterChip(
        ...
        lifecycleScope.launch {
            ...
            updateAppWidgetState(
                ...
                prefs.toMutablePreferences().apply {
                    this[CostSummaryWidget.CAR_ID_KEY] = car.carId
                    this[CostSummaryWidget.CAR_NAME_KEY] = car.displayName
                    this[CostSummaryWidget.RANGE_DAYS_KEY] = range.days
                    this[CostSummaryWidget.PERIOD_LABEL_KEY] = getString(range.labelRes)
                    this[CostSummaryWidget.HAS_DATA_KEY] = false
                }
            }

            CostSummaryWidget().update(this@CostSummaryWidgetConfigActivity, glanceId)
            CostSummaryWidgetUpdateWorker.scheduleImmediateUpdate(this@CostSummaryWidgetConfigActivity)
